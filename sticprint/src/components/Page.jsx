...
//   const [selectedOption, setSelectedOption] = useState("Stone");
...
//   // Define background and text colors for different options
//   const colorMap = {
//     Stone: { bg: "#8B4513", text: "white" }, // Brown
//     Toys: { bg: "#FF4500", text: "white" }, // Orange Red
//     Redium: { bg: "#FFD700", text: "black" }, // Gold
//     PhotoFrame: { bg: "#4682B4", text: "white" }, // Steel Blue
//     Simple: { bg: "#32CD32", text: "white" }, // Lime Green
//   };
...
//         {["Stone", "Redium", "Toys", "PhotoFrame", "Simple"].map((option) => (
...
//         id="printThis"
//         ref={pageRef}
//         style={{ backgroundColor: colorMap[selectedOption].bg }}
//       >
...
//                 key={cellIndex}
//                 style={{
//                   color: colorMap[selectedOption].text,
//                 }}
//               >
//                 <div className="text">{text}</div>
//               </div>
